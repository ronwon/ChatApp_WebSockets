...
socket.on('RecOtherMsg', function(data) {
    let ss = '';
    if(data.name == name) {
        ss = '<div class="roww"><div class="col2"><div class="msssg msssg-color-me msssg-align-left"><p class="texxt texxt-color-me">'+data.msg+'</p></div></div><div class="col1"></div></div>';
    }
    else {
